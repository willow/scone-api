...
def _get_highest_score(scores_list, _array_utils=None):
...
def set_client_bounds_score(client, _score_data_repository=None):
  ...
  highest_prospect_score = _get_highest_score(prospect_scores)
